...
fn ServiceConnector() -> Element {
    ...
    let connect_handler = move |_| async move {
        ...
        crate::state_management::connect(service_client_service, move |dar| async move {
        ...
        div {
            div { class: "dropdown h-full dropdown-end",
                div {
                    ...
                    div {
                        aria_label: "status",
                        class: "status h-6 w-6 my-auto rounded-full",
                        class: if connected() { "status-success" } else { "status-error" },
                    }
                        ...
                        li {
                            button {
                                ...
                                onclick: move |_| async move {
                                    crate::state_management::disconnect(service_client_service).await.ok();
                                },
                                "Disconnect"
                            }
                        }
